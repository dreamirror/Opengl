...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//环境光强度
		lightingShader->setFloat("material.ambientness", 2.0f);

		//镜面光反射参数
		lightingShader->setInt("material.shininess",32);
		...
		//手电筒的有效夹角
		lightingShader->setFloat("light.cutOff",glm::cos(glm::radians(32.5f)));
