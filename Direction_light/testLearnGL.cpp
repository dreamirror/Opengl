...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//环境光强度
		lightingShader->setFloat("material.ambientness", 0.5f);
		...
		lightingShader->setVec3("light.diffuse", glm::vec3(1.5f, 1.50f, 1.5f));
		lightingShader->setVec3("light.specular", glm::vec3(1.5f, 1.5f, 1.5f));
